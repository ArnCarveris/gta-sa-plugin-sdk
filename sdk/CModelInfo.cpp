...
{
	return ((CAtomicModelInfo* (__stdcall *)(int))0x4C6620)(index);
}
...
{
	return ((CDamageAtomicModelInfo* (__stdcall *)(int))0x4C6650)(index);
}
...
{
	return ((CLodAtomicModelInfo* (__stdcall *)(int))0x4C6680)(index);
}
...
{
	return ((CTimeModelInfo* (__stdcall *)(int))0x4C66B0)(index);
}
...
{
	return ((CLodTimeModelInfo* (__stdcall *)(int))0x4C66E0)(index);
}
...
{
	return ((CWeaponModelInfo* (__stdcall *)(int))0x4C6710)(index);
}
...
{
	return ((CClumpModelInfo* (__stdcall *)(int))0x4C6740)(index);
}
...
{
	return ((CVehicleModelInfo* (__stdcall *)(int))0x4C6770)(index);
}
...
{
	return ((CBaseModelInfo* (__stdcall *)(char*, int*))0x4C5940)(name, index);
}
...
{
	return ((CBaseModelInfo* (__stdcall *)(unsigned int, int*))0x4C59B0)(arg0, index);
}
...
{
	return ((CBaseModelInfo* (__stdcall *)(char*, unsigned short*))0x4C59F0)(name, int16index);
}
