...
{
	((void (__thiscall *)(CVehicle*))vtable[23])(this);
}
...
{
	((void (__thiscall *)(CVehicle*, unsigned char))vtable[24])(this, playerNum);
}
...
{
	((void (__thiscall *)(CVehicle*, int, CVector&))vtable[25])(this, componentId, posnOut);
}

// Converted from bool CVehicle::IsComponentPresent(int componentId) 0x871EE8
bool CVehicle::IsComponentPresent(int componentId)
{
	return ((bool (__thiscall *)(CVehicle*, int))vtable[26])(this, componentId);
}
...
{
	((void (__thiscall *)(CVehicle*, CPed*, int, eDoors, float, bool))vtable[27])(this, ped, componentId, door, doorOpenRatio, playSound);
}
...
{
	((void (__thiscall *)(CVehicle*, CPed*, unsigned int, unsigned int, unsigned int, float))vtable[28])(this, ped, doorComponentId, arg2, arg3, arg4);
}
...
{
	return ((float (__thiscall *)(CVehicle*, unsigned int))vtable[29])(this, door);
}
...
{
	((void (__thiscall *)(CVehicle*, CEntity*, unsigned char))vtable[41])(this, damager, bHideExplosion);
}
...
{
	((void (__thiscall *)(CVehicle*, bool, bool, bool, bool))vtable[42])(this, bNoCamShake, bNoSpawnFlyingComps, bDetachWheels, bExplosionSound);
}
...
{
	return ((bool (__thiscall *)(CVehicle*, CColModel*))vtable[43])(this, wheelCol);
}
...
{
	return ((bool (__thiscall *)(CVehicle*, unsigned char, bool))vtable[44])(this, tyreComponentId, bPhysicalEffect);
}
...
{
	return ((bool (__thiscall *)(CVehicle*, unsigned int, CVector*))vtable[45])(this, arg0, arg1);
}
...
{
	((void (__stdcall *)(CVehicle*))0x6D2250)(vehicle);
}
...
{
	return ((RwObject* (__stdcall *)(RwObject*, void*))0x6D2690)(object, data);
}
...
{
	return ((RwFrame* (__stdcall *)(RwFrame*, void*))0x6D26D0)(component, data);
}
...
{
	return ((RpMaterial* (__stdcall *)(RpMaterial*, void*))0x6D2950)(material, data);
}
...
{
	((void (__thiscall *)(CVehicle*, RpAtomic*, int))0x6D2960)(this, atomic, alpha);
}
...
{
	return ((RpAtomic* (__stdcall *)(RpAtomic*, void*))0x6D3300)(atomic, data);
}
...
{
	return ((RpAtomic* (__stdcall *)(RpAtomic*, void*))0x6D3370)(atomic, data);
}
...
{
	return ((RwObject* (__stdcall *)(RwObject*, void*))0x6D33B0)(object, data);
}
...
{
	return ((RwFrame* (__stdcall *)(RwFrame*, void*))0x6D3420)(component, data);
}
...
{
	return ((RwObject* (__stdcall *)(RwObject*, void*))0x6D3450)(object, data);
}
...
{
	return ((RwObject* (__stdcall *)(RwObject*, void*))0x6D3490)(object, data);
}
...
{
	return ((RpAtomic* (__stdcall *)(RpAtomic*, void*))0x6D34D0)(atomic, data);
}
...
{
	return ((bool (__stdcall *)(CVehicle*))0x6E38F0)(vehicle);
}
